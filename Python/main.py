...
# Start over again. You probably don’t need to uninstall any software, but it might make sense to delete your file-name.py file and re-create it from scratch
